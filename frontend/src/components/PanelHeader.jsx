...
function PanelHeader() {
  ...
  return (
    <>
      <div onClick={() => setToggleUserInfo(!toggleUserInfo)} className='cursor-pointer h-16 w-full flex justify-between bg-slate-400 px-4 items-center'>Reporte de usuarios
